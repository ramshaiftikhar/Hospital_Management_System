...
Namespace MySqlWindowsFormsApplication5
	...
	Public Class frmnursing_service
		...
		Private Sub frmnursing_service_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
			...
			Me.Nurse_ID_comboBox.DataBindings.Add(New System.Windows.Forms.Binding("SelectedValue", Me.nursing_serviceBindingSource, "Nurse_ID", True))
			ad3.Dispose()
			...
			Me.Patient_ID_comboBox.DataBindings.Add(New System.Windows.Forms.Binding("SelectedValue", Me.nursing_serviceBindingSource, "Patient_ID", True))
			ad3.Dispose()
			...
			Me.Room_ID_comboBox.DataBindings.Add(New System.Windows.Forms.Binding("SelectedValue", Me.nursing_serviceBindingSource, "Room_ID", True))
			ad3.Dispose()
		End Sub
		...
		Private Sub ToolStripButton1_Click(sender As System.Object, e As System.EventArgs) Handles ToolStripButton1.Click
			If Not Me.Validate() Then
				Return
			End If
			nursing_serviceBindingSource.EndEdit()
        ...
        Private Sub bindingNavigatorAddNewItem_Click(sender As System.Object, e As System.EventArgs) Handles BindingNavigatorAddNewItem.Click
            nursing_serviceBindingSource.AddNew()
        End Sub
        ...
        Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
            nursing_serviceBindingSource.MoveNext()
        End Sub

        Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
            nursing_serviceBindingSource.MovePrevious()
        End Sub

        Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
            nursing_serviceBindingSource.MoveFirst()
        End Sub

        Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
            nursing_serviceBindingSource.MoveLast()
        End Sub
        ...
        Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
            nursing_serviceBindingSource.RemoveCurrent()
        End Sub
	End Class
