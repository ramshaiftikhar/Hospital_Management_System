...
Namespace hospitalDataSet2TableAdapters
    ...
    Partial Public Class testTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `test` WHERE ((`Test_ID` = @p1) AND (`Test_Name` = @p2) AND (`Date` ="& _ 
                " @p3) AND (`Rep_Date` = @p4) AND (`Fee` = @p5))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `test` (`Test_ID`, `Test_Name`, `Date`, `Rep_Date`, `Fee`) VALUES (@p"& _ 
                "1, @p2, @p3, @p4, @p5)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `test` SET `Test_ID` = @p1, `Test_Name` = @p2, `Date` = @p3, `Rep_Date` = "& _ 
                "@p4, `Fee` = @p5 WHERE ((`Test_ID` = @p6) AND (`Test_Name` = @p7) AND (`Date` = "& _ 
                "@p8) AND (`Rep_Date` = @p9) AND (`Fee` = @p10))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT `Test_ID`, `Test_Name`, `Date`, `Rep_Date`, `Fee` FROM `test`"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.MySql.Data.MySqlClient.MySqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        Test_ID, Test_Name, `Date`, Rep_Date, Fee" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM            test" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WH" & _
                "ERE        (Test_ID = @Test_ID)"
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As hospitalDataSet2.testDataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As hospitalDataSet2.testDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As hospitalDataSet2.testDataTable = New hospitalDataSet2.testDataTable()
        ...
        Public Overridable Overloads Function FillBy(ByVal dataTable As hospitalDataSet2.testDataTable, ByVal Test_ID As Integer) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(Test_ID, Integer)
            If (Me.ClearBeforeFill = True) Then
                dataTable.Clear()
            End If
            Dim returnValue As Integer = Me.Adapter.Fill(dataTable)
        ...
        Public Overridable Overloads Function GetDataBy(ByVal Test_ID As Integer) As hospitalDataSet2.testDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(Test_ID, Integer)
            Dim dataTable As hospitalDataSet2.testDataTable = New hospitalDataSet2.testDataTable()
            Me.Adapter.Fill(dataTable)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")> _
        Public Overridable Overloads Function Update(ByVal dataTable As hospitalDataSet2.testDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal p1 As Integer, ByVal p2 As String, ByVal p3 As Date, ByVal p4 As Date, ByVal p5 As Integer) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal p1 As Integer, ByVal p2 As String, ByVal p3 As Date, ByVal p4 As Date, ByVal p5 As Integer) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal p1 As Integer, ByVal p2 As String, ByVal p3 As Date, ByVal p4 As Date, ByVal p5 As Integer, ByVal p6 As Integer, ByVal p7 As String, ByVal p8 As Date, ByVal p9 As Date, ByVal p10 As Integer) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal p2 As String, ByVal p3 As Date, ByVal p4 As Date, ByVal p5 As Integer, ByVal p6 As Integer, ByVal p7 As String, ByVal p8 As Date, ByVal p9 As Date, ByVal p10 As Integer) As Integer
