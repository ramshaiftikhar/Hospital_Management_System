...
Namespace MySqlWindowsFormsApplication5
    ...
    Public Class frmaccountantacc
        ...
        Private Sub Button5_Click(sender As Object, e As EventArgs)
            MsgBox("You don not have the right to do so", MsgBoxStyle.OkOnly)

        End Sub

        Private Sub Button6_Click(sender As Object, e As EventArgs)
            MsgBox("You don not have the right to add new records", MsgBoxStyle.OkOnly)
        End Sub

        Private Sub Button7_Click(sender As Object, e As EventArgs)
            MsgBox("You don not have the right to delete records", MsgBoxStyle.OkOnly)
        End Sub
        ...
        Private Sub ToolStripButton2_Click(sender As Object, e As EventArgs) Handles ToolStripButton2.Click
            Try
                Me.AccountantTableAdapter.Fill(Me.HospitalDataSet.accountant, CType(ToolStripTextBox1.Text, Integer))
