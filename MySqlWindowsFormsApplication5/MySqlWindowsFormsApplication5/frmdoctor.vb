...
Namespace MySqlWindowsFormsApplication5
	...
	Public Class frmdoctor
        ...
        Private Sub Doc_IDTextBox_Validating(sender As Object, e As CancelEventArgs) Handles Doc_IDTextBox.Validating

            e.Cancel = False
            If String.IsNullOrEmpty(Doc_IDTextBox.Text) Then
                e.Cancel = True
                ErrorProvider1.SetError(Doc_IDTextBox, "The field Doc_ID is required")
            End If
            Dim v As Integer
            Dim s As String = Doc_IDTextBox.Text
            If Not Integer.TryParse(s, v) Then
                e.Cancel = True
                ErrorProvider1.SetError(Doc_IDTextBox, "The field Doc_ID must be Integer.")
            End If
            If Not e.Cancel Then
                ErrorProvider1.SetError(Doc_IDTextBox, "")
            End If
        End Sub
		
        Private Sub Doc_NameTextBox_Validating(sender As Object, e As CancelEventArgs) Handles Doc_NameTextBox.Validating

            e.Cancel = False
            If String.IsNullOrEmpty(Doc_NameTextBox.Text) Then
                e.Cancel = True
                ErrorProvider1.SetError(Doc_NameTextBox, "The field Doc_Name is required")
            End If
            If Not e.Cancel Then
                ErrorProvider1.SetError(Doc_NameTextBox, "")
            End If
        End Sub
		
        Private Sub Passed_FromTextBox_Validating(sender As Object, e As CancelEventArgs) Handles Passed_FromTextBox.Validating

            e.Cancel = False
            If String.IsNullOrEmpty(Passed_FromTextBox.Text) Then
                e.Cancel = True
                ErrorProvider1.SetError(Passed_FromTextBox, "The field Passed_From is required")
            End If
            If Not e.Cancel Then
                ErrorProvider1.SetError(Passed_FromTextBox, "")
            End If
        End Sub
        ...
        Private Sub DesignationTextBox_Validating(sender As Object, e As CancelEventArgs) Handles DesignationTextBox.Validating

            e.Cancel = False
            If String.IsNullOrEmpty(DesignationTextBox.Text) Then
                e.Cancel = True
        ...
        Private Sub SpecialityTextBox_Validating(sender As Object, e As CancelEventArgs) Handles SpecialityTextBox.Validating

            e.Cancel = False
            If String.IsNullOrEmpty(SpecialityTextBox.Text) Then
                e.Cancel = True
                ErrorProvider1.SetError(SpecialityTextBox, "The field Speciality is required")
            End If
            If Not e.Cancel Then
                ErrorProvider1.SetError(SpecialityTextBox, "")
            End If
        End Sub
